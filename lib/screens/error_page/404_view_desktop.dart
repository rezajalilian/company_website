...
class NotFoundPageDesktop extends StatelessWidget {
  const NotFoundPageDesktop({Key key}) : super(key: key);
          ...
          Padding(
            ...
            child: Column(
                ...
                children: [
                  errorText,
                  SizedBox(height: 15,),
                  Text(allTranslations.text('error_404_title') ,style: TextStyle(fontFamily: 'Vazir' , fontSize: 25 , fontWeight: FontWeight.w700 , color: Color(0xff010101)), ),
                  SizedBox(height: 15,),
                  Text(allTranslations.text('error_404_desc') ,style: TextStyle(fontFamily: 'Vazir' , fontSize: 18 , fontWeight: FontWeight.w400 , color: Color(0xff010101)), ),
                  SizedBox(height: 20,),
                  GestureDetector(
                    onTap: (){
